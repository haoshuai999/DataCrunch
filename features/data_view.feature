...
Scenario: Upload csv
    ...
    And I should see my first 10 columns from "data.csv"
...
Scenario: Upload json
    ...
    When I click the here link
    And I should see my first 10 columns from "data.json"
...
Scenario: Upload xlsx
    ...
    When I click the here link
    And I should see my first 10 columns from "data.xlsx"
